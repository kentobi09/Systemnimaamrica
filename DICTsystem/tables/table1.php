<div class="table-responsive">
                <table class="table table-hover" data-table-type="diagnostic">
                    <thead>
                                ...
                                <tr data-applicant-id="<?= $applicant['applicantID'] ?>">
                                    <td class="delete-column">
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            ...
                                            <button class="btn btn-secondary edit-applicant-btn" type="button" data-toggle="modal" data-target="#editApplicantModal"
                                                data-id="<?php echo $applicant['applicantID']; ?>"
                                                data-table-type="diagnostic"
